    ...
    partial class Person
    {
        ...
        public Person WithLastName(string LastName)
        {
            return new Person(FirstName, LastName);
                        ...
                        AdditionalSources = new[] { GetRecordAttributeSourceTuple() }
                    }.AndFixedSameAsOld(),
            ...
            return new Person(FirstName, LastName);
                    ...
                    ExpectedDiagnostics = new[]
                    {
                        new DiagnosticResult(RecordPartialMissingDiagnostic.Descriptor, typeName)
                        {
                            Locations =
                            new[] {
                                new DiagnosticResultLocation(filename, 5, 11)
                            }
                        }
                    }
                };
                ...
                public Person WithFirstName(string FirstName)
                {
                    ...
                    ExpectedDiagnostics = new[]
                    {
                        new DiagnosticResult(RecordPartialMissingDiagnostic.Descriptor, typeName)
                        {
                            Locations =
                            new[] {
                                new DiagnosticResultLocation(filename, 14, 27)
                            }
                        }
                    }
                };
                ...
                public Person WithFirstName(string FirstName)
                {
                    ...
                    ExpectedDiagnostics = new[]
                    {
                        new DiagnosticResult(RecordPartialMissingDiagnostic.Descriptor, typeName)
                        {
                            Locations =
                            new[] {
                                new DiagnosticResultLocation(filename, 9, 27)
                            }
                        }
                    }
                };
    ...
    partial class Person
    {
        ...
        public Person WithFirstName(string FirstName)
        {
            return new Person(FirstName);
                ...
                yield return new GeneratorTheoryData
                {
                    Description = "struct implementing interface",
                    SourcePackage = new GeneratorSourcePackage
                    {
                        OldSource = (filename, @"
namespace RecordGeneratorTests
            ...
            return new Person(FirstName);
                    ...
                    ExpectedDiagnostics = new[]
                    {
                        new DiagnosticResult(RecordPartialMissingDiagnostic.Descriptor, typeName)
                        {
                            Locations =
                            new[] {
                                new DiagnosticResultLocation(filename, 7, 20)
                            }
                        }
                    }
                };
            ...
            return new Person(FirstName);
                    ...
                    ExpectedDiagnostics = new[]
                    {
                        new DiagnosticResult(RecordPartialMissingDiagnostic.Descriptor, typeName)
                        {
                            Locations =
                            new[] {
                                new DiagnosticResultLocation(filename, 7, 19)
                            }
                        }
                    }
                };
